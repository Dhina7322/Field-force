      ...
      React.createElement(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props}
        , React.createElement(SheetContent, {
          ...
          , React.createElement(SheetHeader, { className: "sr-only"}
            , React.createElement(SheetTitle, {__self: this}, "Sidebar")
            , React.createElement(SheetDescription, {__self: this}, "Displays the mobile sidebar."   )
          )
...
function SidebarTrigger({
  ...
  return (
    React.createElement(Button, {
      ...
      , React.createElement(PanelLeftIcon, {__self: this} )
...
function SidebarMenuButton({
  ...
  return (
    React.createElement(Tooltip, {__self: this}
